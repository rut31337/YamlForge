...
echo "   • Pre-commit: Schema validation + Vulture will check files before each commit"
echo "   • Post-commit: Schema validation + Vulture will analyze the codebase after each commit"
echo ""
...
echo ""
echo -e "${BLUE}Manual runs:${NC}"
echo "   python tools/validate_schema.py --check-docs  # Run schema validation"
echo "   python tools/validate_schema.py --fix         # Auto-fix schema issues"
